...
//    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        WeatherFragment frag1 = new WeatherFragment();
        ForecastFragment frag2 = new ForecastFragment();
        getChildFragmentManager().beginTransaction().add(R.id.child_fragment_container, frag1).add(R.id.child_fragment_container, frag2).commit();
    }
}